...
const spds = [
  ...
  5000000000000000, 25000000000000000, 1000000000000000000000000000, 1000000000000000000000000000000000000000000000000000000,
...
document.getElementById("buy15").addEventListener("click", () => {
  //cost: 50 NoD
  //speed: 1 Vg
  if (score >= 100000000000000000000000000000000000000000000000000000) {
    score -= 100000000000000000000000000000000000000000000000000000;
    people.push({
      speed: 1000000000000000000000000000000000000000000000000000000,
      upg: 0,
      cost: 200,
